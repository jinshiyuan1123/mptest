...
class DoctorController extends HisBaseController
{
    ...
    public function saveOrder()
    {
        ...
        foreach ($_POST['care_order'] as $k => $v) {
            ...
            $order['addtime'] = time();
            $order['status'] = 0;
            $order['case_code'] = date('YmdHis') . '01' . $this->hospitalInfo['uid'] . '01' . $this->userInfo['uid'] . '01' . rand(10, 99);#处方编号 20181030012901290001
        ...
        $dddd = array(
            ...
            'order_code' => date('YmdHis') . '03' . $this->hospitalInfo['uid'] . '03' . $this->userInfo['uid'] . '03' . rand(10, 99),#商户订单号预防重复  201811201151270364503646036700
        );
...
object(stdClass)#22 (6) {
  ...
  string(1) "Y"
  ["gmt_refund_pay"]=>
  string(19) "2018-11-13 15:16:05"
  ["out_trade_no"]=>
  string(26) "20181110095953031033032956"
  ["refund_fee"]=>
  string(4) "0.01"
  ["send_back_fee"]=>
  string(4) "0.00"
  ["trade_no"]=>
  string(28) "2018111021001004360248374070"
}
