...
<div class="gh-nav">
    <div class="container g-clear">
        <div class="g-left">
                ...
                <a href="https://www.guahao.com/user/login?target=%2Fbefore%2Fconsult%2Fask" rel="nofollow"  onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,login">登录</a>
                <span class="line">|</span>
                <a href="https://www.guahao.com/register/mobile?target=%2Fbefore%2Fconsult%2Fask" rel="nofollow" onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,signin">注册</a>
    ...
    <div class="container g-clear  container-small  ">
        <div class="home-menu-ctn">
            <ul class="g-clear main-menu-nav">
                ...
                <li  class="current"  ><a target="_blank" target="_blank" href="https://www.guahao.com/before/consult/ask" rel="nofollow" onmousedown="return _smartlog(this,'MNU')" monitor="public_menu,home_menu,preciseorder">免费咨询</a></li>
...
<div id="g-cfg" class="gp-consult-qk-v2 J_QKConsult_v2" data-module="consult-ask">
    <div class="gp-breadcrumb-background">
        <div id="g-breadcrumb">
            ...
            <a href="https://www.guahao.com/internet/hospital" onmousedown="return _smartlog(this,'NAV')">在线问诊</a>&gt;
            <span>免费咨询</span>
        </div>
    </div>
    ...
    <div class="contain">
            ...
            <div class="g-consult-form qk">
                <form class="grid-form" action="/json/bconsult/asksubmit" method="post" name="consult" id="form-consult" autocomplete="off">
                    ...
                    <div class="item info">
                        ...
                        <div class="contain">
                            <div class="row J_PatientList">
                                <p class="add">
                                    <a href="javascript:;" class="manage J_AddPatientBtn" target="_blank" monitor="freeask_ask,freeask_ask,addinfo" rel="#J_AddPatient"><span>添加新的就诊人并完善资料&nbsp;</span><span class="info-manage-icon"></span></a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="item mobile">
                        ...
                        <div class="contain">
                            ...
                            <p class="g-txt-gray-lightest" style="font-size:12px;">
                                请确保手机通畅，以便病情需要时，医生能及时联系到您。
                            </p>
                        </div>
                    </div>
                    <div class="item info">
                        <label><span class="gfm-required-mark">*</span>是否去线下医院就诊过：</label>
                        <div class="contain">
                    ...
                    <div class="item when-long">
                        <label><span class="gfm-required-mark">*</span>患病时长：</label>
                        <div class="contain">
                            <div class="row">
                                <select name="sickTime" class="select-long" style="height: 40px;">
                                    <option value="">请选择患病时长</option>
                                    <option value="一周">一周</option>
                                    <option value="一月">一月</option>
                                    <option value="半年">半年</option>
                                    <option value="大于半年">大于半年</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="item desc">
                        <label for="f-desc"><span class="gfm-required-mark">*</span>病情描述：</label>
                        <div class="contain">
                                <div class="row">
                                    <textarea name="consultContent" class="long J_Desc" id="f-desc" data-message="请输入10-500个字" pattern="^(.|\n){10,500}$" data-required="1" placeholder="详实的病情描述将得到更专业的咨询指导"></textarea>
        ...
        <a href="https://www.guahao.com/intro/userapp" target="_blank" monitor="freeask_resource,freeask_resource,appadv">
        <div class="right-ad"></div></a>
