          ...
          <div class="g-right">
            ...
            <div class="gh-main">
				...
				<span class="search-icon"></span>
                            <input type="text" name="q" value="" placeholder="请输入疾病名、科室名、医院名或医生名" />
                            <input type="hidden" name="searchType" id="search" value="search" class="">
                            </span>
                            <a class="gbn gbt-green2 radius-right big-search-bt" target="_blank" href="javascript:void(0);">搜索</a>
                            <div class="clear"></div>
                        </form>
                ...
                <div class="container g-clear  ">
                    <div class="home-menu-ctn">
                        <ul class="g-clear main-menu-nav">
                            ...
                            <li class="authority"><a class="own-tab" target="_blank" target="_blank" href="<?php echo U('home/index/baike');?>" rel="nofollow">互联网医学百科</a></li>
                            <li data-subnav="sub-nav-welife"><a target="_blank" rel="nofollow" onmousedown="return _smartlog(this,'MNU')">
					择医网健康</a>
                            </li>
                            <li><a target="_blank" href="<?php echo U('home/index/eteam');?>" onmousedown="return _smartlog(this,'MNU')" monitor="public_menu,home_menu,spteam">专家团队</a></li>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.big-search-bt').click(function(){
                        alert(0);
                        window.location.href="http://sou.bei.com/Home/search?q=222&searchType=search_query";
                    });
                });
            </script>
        </div>
